...
class MAPRMSampler:
	...
	def sampleISOn( self, cost, surf=None ):
		vertices = [];
		inits = [];
		...
		for init in inits:
			self.__sampleISOn__( init, cost, samples, surf );

		return samples;


	def __sampleISOn__( self, initPnt, cost, samples, surf ):
...
samples3 = sampler.sampleISOn( 34 );
