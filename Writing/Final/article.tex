...
\begin{algorithmic}[1]
	\Function {IncrementalBetti}{$\sigma_1, \sigma_2, ..., \sigma_m$}
		\State $\beta_0 = \beta_1 = \beta_2 = 0$
		\For {$i \in $ \emph{0 to m}}
			\If {$\sigma_i$ \emph{belongs to a k-cycle of $K_i$}}
...
\begin{figure}
	\center{\includegraphics[scale=0.28]{./pics/Torus.png}}
...
\begin{figure}
	\center{ \includegraphics[scale=0.4]{./pics/broken_graph.png} }
...
\begin{figure}
	\center{ \includegraphics[scale=0.2]{./pics/Analysis_PvB.png} }
	\caption{\label{PvB}} Relation between number of initial configurations and balls. The number of balls tends to be around 120.
\end{figure}

\begin{figure}
	\center{ \includegraphics[scale=0.4]{./pics/overview_uncovered_pixels.PNG} }
...
\begin{figure}
	\center{ \includegraphics[scale=0.35]{./pics/AstarSearch.PNG} }
...
\begin{thebibliography}{1}
  \bibitem{incre_betti} Delfinado, Cecil Jose A., and Herbert Edelsbrunner. "An incremental algorithm for Betti numbers of simplicial complexes on the 3-sphere." Computer Aided Geometric Design 12.7 (1995): 771-784.
